...
| 데이터(User)| `ContextUp/userdata/` | 개인 설정, API 키 (Git 제외) |

> [!IMPORTANT]
> **V4.0.0 업데이트**: 사용자 데이터 파일이 `config/`에서 `userdata/` 디렉토리로 이동되었습니다. 기존 사용자는 설치 시 자동으로 마이그레이션됩니다.
