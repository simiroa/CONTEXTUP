    ...
    if download_file(FFMPEG_URL, zip_path):
        if extract_zip(zip_path, TEMP_DIR):
            ...
            if extracted_dirs:
                ...
                print(f"✓ FFmpeg 설치 완료: {target_dir}")
    ...
    if download_file(REALESRGAN_URL, zip_path):
        if extract_zip(zip_path, TEMP_DIR):
            ...
            if found_exe:
                ...
                print(f"✓ Real-ESRGAN 설치 완료: {target_dir}")
            else:
                 print(f"✗ 추출된 파일에서 Real-ESRGAN 실행 파일을 찾을 수 없습니다.")
    ...
    if download_file(RIFE_URL, zip_path):
        if extract_zip(zip_path, TEMP_DIR):
            ...
            if found_dir:
                ...
                print(f"✓ RIFE 설치 완료: {target_dir}")
            else:
                 print(f"✗ 추출된 파일에서 RIFE 실행 파일을 찾을 수 없습니다.")
