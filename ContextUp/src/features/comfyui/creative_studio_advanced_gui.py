...
class CreativeStudioAdvancedGUI(PremiumComfyWindow):
    def __init__(self):
        super().__init__(title="Creative Studio (Advanced)", width=1380, height=950)
    ...
    def _setup_layout(self):
        ...
        self.btn_ignite = ActionButton(self.footer, text="🚀 Ignite Advanced", variant="magic", height=50, command=self.start_generation)
        ...
        self.preview_label = ctk.CTkLabel(self.viewport, text="Wrapped Engine Ready.", font=Fonts.HEADER)
