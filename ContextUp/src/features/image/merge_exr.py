...
class ExrChannelPackerGUI(BaseWindow):
    ...
    def create_widgets(self):
        ...
        ctk.CTkButton(top_header, text="+ Custom Pass", width=120, height=30, command=lambda: self.add_channel(None)).pack(side="right")
    ...
    def export_exr(self):
        try:
            ...
            if not active_configs:
                messagebox.showwarning("Warning", "No layers have assigned files.")
                return
