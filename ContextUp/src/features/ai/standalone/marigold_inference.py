...
try:
    ...
    print("Error: Could not import utils.paths. Ensure src is in PYTHONPATH.")
    sys.exit(1)
...
def main():
    ...
    def save_output(data, path, mode="depth", flip_y=False):
        ...
        elif mode in ["normal", "albedo", "roughness", "metallicity", "orm"]:
    ...
    try:
        ...
        if args.normal:
            ...
            print(f"Loading Normal Model ({ckpt}) from {cache_dir}...")
        ...
        if args.albedo or args.roughness or args.metallicity or args.orm:
            ...
            print(f"Loading IID Appearance Model ({ckpt}) from {cache_dir}...")
                ...
                if pred_np.shape[0] == 2 and pred_np.ndim == 4:
                    ...
                    if args.roughness:
                        ...
                        if args.invert_roughness:
                             # Invert
                             if r_data.min() < 0: r_data = (r_data + 1.0) / 2.0
                             r_data = 1.0 - r_data
