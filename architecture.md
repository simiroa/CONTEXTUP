...
*   **Single Environment**: A standalone, portable Python 3.12 build (IndyGreg) located in `tools/python/`.
...
*   `config/menu_categories/`: **Source of Truth**. JSON files defining menu structure. Loaded directly by Manager and Core.
...
*   **Adding a New Tool**:
    ...
    2.  Add entry to `config/menu_categories/*.json`.
