...
class PromptMasterApp(PresetMixin, TagLibraryMixin, TranslationMixin, ImageMixin, ctk.CTk):
    ...
    def __init__(self):
        ...
        self.top_bar = ctk.CTkFrame(main_container, height=50, corner_radius=0, fg_color="gray15")
        self.top_bar.grid(row=0, column=0, columnspan=3, sticky="ew")
        
        # Logo on left
        logo = ctk.CTkLabel(self.top_bar, text="Prompt Master", font=ctk.CTkFont(size=18, weight="bold"))
        ...
        Tooltip(self.preset_search, "Search Presets")
        ...
        Tooltip(self.open_folder_btn, "Open Presets Folder")
        ...
        Tooltip(self.guide_btn, "Add New Preset Guide")
        ...
        self.builder_frame = ctk.CTkFrame(self.center_frame, fg_color="gray15", corner_radius=10)
        ...
        self.tag_library_frame = ctk.CTkFrame(self.center_frame, corner_radius=10, fg_color="gray15")
        ...
        tag_header = ctk.CTkLabel(
            ...
            text="🏷️ Tag Library / User Context",
        ...
        # Output Display Container (Black Box)
        self.output_container = ctk.CTkFrame(self.right_frame, fg_color="gray10", corner_radius=10)
        ...
        Tooltip(self.optimize_btn, "Optimize Prompt")
        ...
        Tooltip(self.clear_btn, "Clear All")
    ...
    def build_ui(self):
        ...
        if not self.current_preset_data:
            ...
            self.builder_title.configure(text="Select a Preset")
            return
