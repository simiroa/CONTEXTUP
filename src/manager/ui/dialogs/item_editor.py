...
class ItemEditorDialog(ctk.CTkToplevel):
    def __init__(self, parent, item_data=None, on_save=None, on_delete=None):
        ...
        self.text_deps = ctk.CTkTextbox(self.frame, height=60)
        self.text_deps.grid(row=11, column=1, sticky="ew", pady=10, padx=10)
        
        # Buttons
        btn_frame = ctk.CTkFrame(self.frame, fg_color="transparent")
        btn_frame.grid(row=12, column=0, columnspan=3, pady=20, sticky="ew")
