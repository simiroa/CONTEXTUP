...
class TrayProcessManager:
    def __init__(self, root_dir: Path, settings: dict):
        ...
        self.script_path = root_dir / "src" / "scripts" / "tray_agent.py"
    ...
    def _resolve_python_executable(self):
        # Always prefer the current interpreter (sys.executable)
        # Assuming this is what we want for Conda/Venv compatibility
